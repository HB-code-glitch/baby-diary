...
describe('packaged cross-platform sync E2E runner contract', () => {
  ...
  it('resolves only real regular files in the expected packaged Windows or macOS structure', () => {
    ...
    const installedWin = path.join(root, 'AppData', 'Local', 'Programs', 'baby-diary', 'Baby Diary.exe')
    const installedWinResources = path.join(root, 'AppData', 'Local', 'Programs', 'baby-diary', 'resources', 'app.asar')
