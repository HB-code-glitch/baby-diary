/**
 * WHO Child Growth Standards (2006) — LMS parameters, birth to 24 months, monthly.
 * Source (extracted verbatim from official WHO xlsx, cross-checked against WHO PDF charts & CDC tables):
 *  - wfa_boys_0-to-5-years_zscores.xlsx / wfa_girls_0-to-5-years_zscores.xlsx
 *  - lhfa_boys_0-to-2-years_zscores.xlsx / lhfa_girls_0-to-2-years_zscores.xlsx
 * Z = ((X/M)^L - 1) / (L*S); length uses L=1 (normal): Z = (X-M)/(M*S).
 * 수치 임의 수정 금지 — WHO 원본과 1:1 대응.
 */
...
export const LHFA_BOYS: LmsPoint[] = [
...
export const LHFA_GIRLS: LmsPoint[] = [
